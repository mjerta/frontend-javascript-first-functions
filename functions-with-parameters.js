...
function calculateDogYears(dogYears) {
  console.log(`Jouw hond is ${dogYears} jaar oud in mensenjaren.`);
}
...
function createDetailString(personDetails) {
  console.log(`Het beroep van ${personDetails.firstName} ${personDetails.lastName} is ${personDetails.profession}`);
}

createDetailString(personDetails);